...
<li><b>Methods vs functions.</b> <code>nums.append(6)</code> mutates in place; <code>sorted(nums)</code> returns a copy.</li>
...
<li><b><code>print()</code> is a function</b>, not a statement.</li>
</ol>
]
